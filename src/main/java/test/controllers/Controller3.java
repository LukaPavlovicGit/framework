...
public class Controller3 {
    ...
    private static final String controllerName = "Controller-3";
    ...
    @GET
    @Path(path = "/controller3/endpoint1")
    public Response endpoint1(Request request) {
        System.out.println(controllerName + ": GET /controller3");
    ...
    @GET
    @Path(path = "/controller3/endpoint2")
    public void endpoint2() {
        System.out.println(controllerName + ": GET /controller3/method1");
    }

    @POST
    @Path(path = "/controller3/endpoint3")
    public Response endpoint3(Request request) {
        System.out.println(controllerName + ": POST /controller3/method2");
